...
/// Create a version stamp that identifies the version of newdoc that generated the module file.
/// Example:
/// Generated by newdoc 2.14.1 (built on 2023-09-01)
fn generator_version() -> String {
    ...
    format!("Template generated by {name} {version} built on {year}-{month}-{day}.")
}
